...
repo --name=adaptation-community-ham-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/zuk:/ham/sailfish_latest_@ARCH@/
repo --name=adaptation-community-common-ham-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
