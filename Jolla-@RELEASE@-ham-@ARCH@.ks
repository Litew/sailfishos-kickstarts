...
repo --name=adaptation-community-ham-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/testing:/hw:/zuk:/ham/sailfishos_@RELEASE@/
repo --name=adaptation-community-common-ham-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/testing:/hw:/common/sailfishos_@RELEASE@/
...
%packages
@Jolla Configuration ham
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/ham
