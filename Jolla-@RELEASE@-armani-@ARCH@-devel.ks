# DisplayName: Jolla armani/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: armani
# DeviceVariant: armani
...
repo --name=adaptation-community-armani-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/xiaomi:/armani/sailfish_latest_@ARCH@/
repo --name=adaptation-community-common-armani-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration armani
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/armani
