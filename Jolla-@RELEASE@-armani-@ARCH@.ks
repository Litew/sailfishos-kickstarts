...
repo --name=adaptation-community-armani-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/testing:/hw:/xiaomi:/armani/sailfishos_@RELEASE@/
repo --name=adaptation-community-common-armani-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/testing:/hw:/common/sailfishos_@RELEASE@/
